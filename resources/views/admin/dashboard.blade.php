        ...
        <main id="main-container">
            ...
            <div class="content">
                ...
                <div class="content-heading">
                    Result <small class="d-none d-sm-inline">score pangestu</small>
                </div>
                            ...
                            <div class="block-content block-content-full block-sticky-options">
                                ...
                                <div class="py-20 text-center">
                                    <div class="font-size-h2 font-w700 mb-0 text-white" data-toggle="countTo"
                                        data-to="{{count($klub)}}">0</div>
                                    <div class="font-size-sm font-w600 text-uppercase text-white-op">Klub</div>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <a class="block block-rounded block-transparent bg-gd-dusk" href="be_pages_ecom_orders.html">
                            <div class="block-content block-content-full block-sticky-options">
                                ...
                                <div class="py-20 text-center">
                                    <div class="font-size-h2 font-w700 mb-0 text-white" data-toggle="countTo"
                                        data-to="{{count($riwayat)}}">0</div>
                                    <div class="font-size-sm font-w600 text-uppercase text-white-op">Pertandingan</div>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <a class="block block-rounded block-transparent bg-gd-sea" href="javascript:void(0)">
                            <div class="block-content block-content-full block-sticky-options">
                                ...
                                <div class="py-20 text-center">
                                    <div class="font-size-h2 font-w700 mb-0 text-white" data-toggle="countTo"
                                        data-to="{{$klasemen->sum('point')}}">0</div>
                                    <div class="font-size-sm font-w600 text-uppercase text-white-op">Jumlah Point
                                    </div>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <a class="block block-rounded block-transparent bg-gd-aqua" href="javascript:void(0)">
                            <div class="block-content block-content-full block-sticky-options">
                                ...
                                <div class="py-20 text-center">
                                    <div class="font-size-h2 font-w700 mb-0 text-white">{{$klasemen->first()->klub->nama}}</div>
                                    <div class="font-size-sm font-w600 text-uppercase text-white-op">Tertinggi</div>
                                </div>
                            </div>
                        </a>
                    </div>
